  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <a class="btn btn-success" href="permisos">Administrar Permisos</a>
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        foreach ($usuarios as $key => $value){
          ...
          echo ' <tr>
                  ...
                  $perfil = ControladorUsuarios::ctrMostrarPerfil($itemPerfil, $valorPerfil);
                ...
                <div class="input-group">
                  ...
                  <select class="form-control input-lg" name="nuevoPerfil">
                    ...
                    <?php
                      ...
                      $perfil = ControladorUsuarios::ctrMostrarPerfil($item, $valor);
                ...
                <div class="input-group">
                  ...
                  <?php 
                    ...
                    foreach ($permisos as $key => $value) {
                      ...
                      <input type="checkbox" name="permiso[]" value="'.$value["id"].'"> '.$value["nombre"].'

...
class ControladorDelivery{
	...
	/*=============================================
	MOSTRAR DELIVERY POR RANGO DE FECHAS
	=============================================*/	

		static public function ctrRangoFechasDelivery($fechaInicial, $fechaFinal){

			$tabla = "camion";

			$respuesta = ModeloDelivery::mdlRangoFechasDelivery($tabla, $fechaInicial, $fechaFinal);
